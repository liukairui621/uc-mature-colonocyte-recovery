...
JM=pd.DataFrame([fit(J,m,'joint_primary_site_then_patient_set') for m in ['delta_ct_logit_epi','delta_ct_state_score','composition_contribution','within_state_contribution']])
checks={}
